        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="order-2 md:order-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-salon-800 mb-1">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-salon-800 mb-1">
                    Email Address
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="phone" className="block text-sm font-medium text-salon-800 mb-1">
                    Phone Number
                  </label>
                  <input
                    type="tel"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-salon-800 mb-1">
                  Message
                </label>
                <textarea
                  id="message"
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      <a href="tel:+14155550123" className="hover:text-salon-500 transition-colors">
                        +1 (415) 555-0123
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      <a href="mailto:info@alkasthenailbar.com" className="hover:text-salon-500 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-medium text-salon-800 mb-1">Business Hours</h4>
