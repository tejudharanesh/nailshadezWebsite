...
const Index = () => {
  ...
  useEffect(() => {
    ...
    `;
    scrollToTopBtn.className = 'fixed bottom-8 right-8 w-12 h-12 rounded-full bg-salon-500 text-white flex items-center justify-center shadow-lg opacity-0 transition-all duration-300 z-40 invisible';
